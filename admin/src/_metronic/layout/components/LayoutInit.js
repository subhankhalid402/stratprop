...
export function LayoutInit() {
  useLayoutEffect(() => {
    ...
    KTUtil.ready(function() {
      ...
      KTLayoutAsideMenu.init("kt_aside_menu_routes");
      KTLayoutAsideMenu.init("kt_aside_menu_users");
      KTLayoutAsideMenu.init("kt_aside_menu_payments");
      KTLayoutAsideMenu.init("kt_aside_menu_bookings");
      KTLayoutAsideMenu.init("kt_aside_menu_dashboard");
      KTLayoutAsideMenu.init("kt_aside_menu_miscellaneous");
      KTLayoutAsideMenu.init("kt_aside_menu_buses");
